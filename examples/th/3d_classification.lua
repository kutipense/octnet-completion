...
function dataset(N)
  ...
  local outputs = torch.Tensor(N):fill(0) -- CrossEntropyCriterion has problems with class '0'
  for i = 1, N do
    -- Variable sizes seem to be infeasible for the network,
    -- although it works in C++ ...
    -- Ok Combination of initialization and switching to ReLU solved it!
