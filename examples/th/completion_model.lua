...
local function create_model(opt)
    ...
    -- 8x8x8
    conv3 = nn.Sequential()
        :add(oc.OctreeConvolutionMM(num_features * 2, num_features * 8))
    ...
    local L3 = L2 - conv3
    -- local L4 = L3 - conv4
    local L5 = L3 - bottleneck
    -- local L6 = nn.JoinTable(2)({ L5, L4 }) - deconv1
    local L7 = nn.JoinTable(2)({ L5, L2_2 }) - deconv3
    -- local L8 = nn.JoinTable(2)({ L7, L2_2 }) - deconv3
    local L9 = nn.JoinTable(2)({ L7, L1_2 }) - deconv4
